...
time.sleep(0.5)
print("[/] Hey Kamu,Dapat Tools Dari R.C.C Ya")
time.sleep(0)
print ("[\] Kenalin Aku CwukupTauw")
time.sleep(0)
print("======================")
print("[=] Buat Aku Desah Ya:) [=]")
print("======================")
time.sleep(0)
print("Connect To Progams Tools CwukupTauw")
time.sleep(1)
print("Pengen Sepong Titid Kamu Beneran:)")
print("                          ")
time.sleep(0)
print(" ")
print(" ")
...
print(" ")
print(" ")
print("Hey I Love You Mwah")
print(" ")
print(" ")
print(" ")
print(" ")
print(" ")
print("Tools Ini Buatan CwukupTauw")
print(" ")
print(" ")
print(" ")
print(" ")
print(" ")
print(" ")
print("Sabar Tayang Bentar Lagi")
print(" ")
print(" ")
print(" ")
print(" ")
...
print(" ")
print(" ")
name = str(input("Berapa Cm TitidMu? : "))
ip = str(input("Masukin Ke MemekKu/IP : "))
port = int(input("Berapa Ronde?/Port: "))
times = int(input("Mau Berapa Packets? : "))
threads = int(input(" Makasih Udah Order Aku:) Hamil Salah Kamu Ya/Thread: "))
fake_ip = 'NASA.gov'
fakeip = '29.80.32.56.98.34.29'
fake_ip = "AsLtroScrty D0S"
fakeip = "AsLtroScrty D0S"
